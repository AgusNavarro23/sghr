...
const navigation = [
  ...
  { name: "Empleados", href: "/employer/employees", icon: Users },
  { name: "Licencias", href: "/employer/leaves", icon: Calendar },
  { name: "Nómina", href: "/employer/payroll", icon: DollarSign },
  { name: "WhatsApp AI", href: "/employer/whatsapp", icon: MessageSquare },
  { name: "Configuración", href: "/employer/settings", icon: Settings },
]
